...
# 归一化特征
def normalization(SS,CR,SF,FM,versionPath):

    res_nor = Tool_io.checkAndLoad(versionPath[1], "normalization")
    if res_nor != None:
        return res_nor
    ...
    Tool_io.checkAndSave(versionPath[1], "normalization", res_nor)
    return res_nor
